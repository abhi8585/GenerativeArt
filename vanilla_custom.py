...
from main_utils import build_discriminator
from main_utils import build_generator
from main_utils import sample_images
...
train(generator,discriminator,gan_model,epochs=30000, batch_size=32, sample_interval=1000)